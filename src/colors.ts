const colors: { code: string; label: string; slug: string }[] = [
  { code: '#3d3e3e', label: 'Anthracite', slug: 'anthracite' },
  { code: '#000001', label: 'Black', slug: 'black' },
  { code: '#393732', label: 'Dark Heather Grey', slug: 'dark-heather-grey' },
  { code: '#0d745c', label: 'Earth Green', slug: 'earth-green' },
  { code: '#feaea3', label: 'Foxy Pink', slug: 'foxy-pink' },
  { code: '#b3b0ab', label: 'Heather Grey', slug: 'heather-grey' },
  { code: '#4a4940', label: 'Khaki', slug: 'khaki' },
  { code: '#b8a2ca', label: 'Lilac', slug: 'lilac' },
  { code: '#7e8ea5', label: 'Mid Heather Blue', slug: 'mid-heather-blue' },
