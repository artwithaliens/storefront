...
const countries: { code: keyof typeof CountriesEnum; label: string }[] = [
  ...
  { code: 'GS', label: 'South Georgia/Sandwich Islands' },
  ...
  { code: 'UM', label: 'United States (US) Minor Outlying Islands' },
